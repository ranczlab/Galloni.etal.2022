...
params.addParameter('LineWidth', 1, @(x) isnumeric(x) && x>=0);
...
H = makePlot(x,y,errBar,lineProps,transparent,patchSaturation,LineWidth);
...
function H = makePlot(x,y,errBar,lineProps,transparent,patchSaturation,LineWidth)
